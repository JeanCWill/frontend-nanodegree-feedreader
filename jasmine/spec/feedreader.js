...
$(function() {
    ...
    */
    describe('RSS Feeds', function() {
         ...
         */
         it('are defined and not empty URL for all feeds', function() {
         ...
         */
         it('are defined and not empty name for all feeds', function() {
            allFeeds.forEach(function(feed){
    ...
    describe('New Feed Selection', function() {
        ...
        it('change content with a new feed', function( done ) {
            loadFeed(2, function() {
